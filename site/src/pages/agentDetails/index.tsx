      ...
      <MainLayout>
        <StyledContent>
          ...
          <Breadcrumb>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink href="#/agents">Агенты</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbItem isCurrentPage>
              <BreadcrumbLink href="#/agents">
                {currentAgent.surname ? currentAgent.surname + " " : ""}{" "}
                {currentAgent.name ? currentAgent.name + " " : ""}{" "}
                {currentAgent.thirdname ? currentAgent.thirdname + " " : ""}
              </BreadcrumbLink>
            </BreadcrumbItem>
          </Breadcrumb>
          <Spacer height={5} />
            ...
            <div className="right">
              <Flex wrap={"wrap"} justifyContent={"space-between"}>
                <div className="name">
                  ...
                  {agent.thirdname ? agent.thirdname + " " : ""}
                </div>
                <div className="count">
                  {count} {declOfNum(count, ["объект", "объекта", "объекты"])}
                </div>
              </Flex>
